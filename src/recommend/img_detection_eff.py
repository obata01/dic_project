...
#         x = layers.Dense(6144, activation=layers.LeakyReLU(), kernel_regularizer=regularizers.l2(0.0001), kernel_initializer=initializer, bias_initializer='zeros')(x)
# #         x = layers.Dropout(rate=0.3)(x)
#         x = layers.Dense(6144, activation=layers.LeakyReLU(), kernel_regularizer=regularizers.l2(0.0001), kernel_initializer=initializer, bias_initializer='zeros')(x)
# #         x = layers.Dropout(rate=0.3)(x)
        x = layers.Dense(1024, activation=layers.LeakyReLU(), kernel_regularizer=regularizers.l2(0.001), kernel_initializer=initializer, bias_initializer='zeros')(x)
#         x = layers.Dropout(rate=0.4)(x)
        x = layers.Dense(1024, activation=layers.LeakyReLU(), kernel_regularizer=regularizers.l2(0.001), kernel_initializer=initializer, bias_initializer='zeros')(x)
#         x = layers.Dropout(rate=0.4)(x)
        x = layers.Dense(512, activation=layers.LeakyReLU(), kernel_regularizer=regularizers.l2(0.001), kernel_initializer=initializer, bias_initializer='zeros')(x)
#         x = layers.Dropout(rate=0.4)(x)
...
#             image = tf.image.resize(image, [int(img_size*1.01), int(img_size*1.01)])
...
#             train_df['img'] = glob.glob(img_path + '*.[jp][pn]g')
            train_df['img'] = glob.glob(img_path + '*.jpg')
#             train_df['item_id'] = train_df['img'].apply(lambda x: re.sub('(.jpg|_2.png)', '', x[43:]))
            train_df['item_id'] = train_df['img'].apply(lambda x: re.sub('(.jpg|1_.jpg|_2.jpg|_3.jpg|_4.jpg|_5.jpg|_6.jpg|_7.jpg|_8.jpg|_9.jpg)', '', x[43:]))
